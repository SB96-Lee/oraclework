...
CREATE TABLE TB_PUBLISHER (
    PUB_NO NUMBER CONSTRAINT PUBLISHER_PKY PRIMARY KEY,
    PUB_NAME VARCHAR2(50) CONSTRAINT PUBLISHER_NN NOT NULL,
    PHONE VARCHAR2(13)
);

INSERT INTO TB_PUBLISHER VALUES(1, '더조은', NULL);
INSERT INTO TB_PUBLISHER VALUES(2, '참조은', '02-6545-1234');
INSERT INTO TB_PUBLISHER VALUES(3, '댕조은', '02-1234-6432');
INSERT INTO TB_PUBLISHER VALUES(4, '헬조은', '02-1334-6432');
INSERT INTO TB_PUBLISHER VALUES(5, '갱조은', '02-1534-6432');
...
INSERT INTO TB_BOOK VALUES(1, '헨젤과그레텔', '헨젤', 15000, 1);
INSERT INTO TB_BOOK VALUES(2, '빨간모자', '늑대', 25000, 2);
INSERT INTO TB_BOOK VALUES(3, '아기염소3형제', '염소형제', 35000, 3);
INSERT INTO TB_BOOK VALUES(4, '흑설공주', '흑설이', 16000, 4);
INSERT INTO TB_BOOK VALUES(5, '운동델라', '운동이', 12000, 5);
...
INSERT INTO TB_MEMBER VALUES(1, 'user1', 'pwd1', '김떙떙', 'M', NULL, NULL, null, '25/02/10');
INSERT INTO TB_MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, GENDER) VALUES(2, 'user2', 'pwd2', '장떙떙', 'F');
INSERT INTO TB_MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, GENDER) VALUES(3, 'user3', 'pwd3', '박떙떙', 'F');
INSERT INTO TB_MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, GENDER) VALUES(4, 'user4', 'pwd4', '황떙떙', 'F');
INSERT INTO TB_MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, GENDER) VALUES(5, 'user5', 'pwd5', '선우떙떙', 'F');
...
INSERT INTO TB_RENT VALUES(2,2,2, '25/01/31');
INSERT INTO TB_RENT(RENT_NO, RENT_MEM_NO, RENT_BOOK_NO) VALUES(3,3,3);