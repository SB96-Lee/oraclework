...
/*
    *시퀀스 객체 생성
    ...
    [INCREMENT BY 숫자]          -> 몇씩 증가 시킬지(기본값 1씩 증가)
...
/*
    *시퀀스 사용
     시퀀스명.CURRVAL: 현재 시퀀스의 값(마지막으로 성공하여 실행된 NEXTVAL(값)
     시퀀스명.NEXTVAL: 시퀀스값에 일정하게 증가시켜서 발생된 값
                      현재 시퀀스 값에서 INCREMENT BY한 값
...
SELECT SEQ_EMPNO.NEXTVAL FROM DUAL; --MAXVALUE 초과 오류
