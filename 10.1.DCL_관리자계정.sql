...
GRANT CREATE SESSION TO SAMPLE;
    --접속하여 테이블을 만들면 오류. 테이블을 만들 수 있는 권한이 없음
    
--3. 테이블을 생성할 수 있는 권한 부여
GRANT CREATE TABLE TO SAMPLE;

--4. 테이블에 데이터를 삽입하려면 tablespace를 줘야한다
...
/*
    ...
    CONNECT : CREATE(생성권한), SESSION(접속권한)
    RESOURCE : CREATE TABLE, CREATE SEQUENCE, ... 리소스에 접근해서 조작할 수 있는 모든 권한
